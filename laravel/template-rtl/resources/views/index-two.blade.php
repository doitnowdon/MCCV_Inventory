...
<div class="page-wrapper page-wrapper-two">
    <div class="content">
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 col-12 d-flex">
                <div class="dash-widget dash1 flex-fill">
                    <div class="dash-widgetimg">
            ...
            <div class="col-lg-3 col-sm-6 col-12 d-flex">
                <div class="dash-widget dash2 flex-fill">
                    <div class="dash-widgetimg">
                        <span><img src="{{ URL::asset('/assets/img/icons/dash3.svg')}}" alt="img"></span>
                    </div>
                    <div class="dash-widgetcontent">
                        <h5 >$<span class="counters" data-count="385656.50">385,66.50</span></h5>
                        <h6>Total Sale Amount</h6>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 col-12 d-flex">
                <div class="dash-widget dash3 flex-fill">
                    <div class="dash-widgetimg">

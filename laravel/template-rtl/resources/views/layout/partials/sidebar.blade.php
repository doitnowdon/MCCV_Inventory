...
@endif
    <div class="sidebar-inner slimscroll">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
                <li class="submenu">
                    <a href="javascript:void(0);" class="active"><img src="assets/img/icons/menu-icon.svg" alt="img"><span> Main Menu</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="index" class="active"><img src="assets/img/icons/dashboard.svg" alt="img"><span> Dashboard</span> </a></li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/product.svg" alt="img"><span> Product</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="productlist">Product List</a></li>
